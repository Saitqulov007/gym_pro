...
from apps.users.views import (CreateUser, MembersListView, UserDetail, UserRegistrationView,
                              activate_lead, canceled_lead, lead_delete, lead_edit, leads, login_view,
                              LogOutView, UserUpdateView, StaffListView, UserDelete, is_user_registered,
                              register_new_user, my_subscription, my_sessions)
